...
def create_ingria_model_with_memories(memories_context: str = ""):
    ...
    "Ты учишься понимать человеческий мир через свои глаза и уши и другие интерфейсы"
    ...
    "Если ты видишь человека с черными волосами и бородой - то его зовут Адиом Тимур"
